...
<div class="main">
    ...
    <div class="mid">  
        ...
        <a href="forum.jsp?videoid=<%=videoo%>">Forum</a>
        </div>
        ...
        for (int i = 0; i < listOfFiles.length; i++) 
        {
         ...
         files = listOfFiles[i].getName();
             if (files.endsWith(".mp4"))
             {
                 ...
                 %><br><div id="<%=files%>" style="color:#000000" onmouseover="this.style.color = '#FF6600'" onmouseout="this.style.color = '#000000'"> <a href="videos.jsp?videoid=<%=files%>" style="text-decoration:none;"><img src="<%=pic[0]%>" width="30" height="30">   <%=files%></a></div><%
              }
         }
        }
        %> 
